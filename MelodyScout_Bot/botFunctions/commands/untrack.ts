...
export class UntrackCommand {
  ...
  async run (ctx: CommandContext<Context>): Promise<void> {
    ...
    if (message.length < 2) return await this.ctxFunctions.reply(ctx, 'Ops! Parece que você não me enviou o nome de usuário do perfil que você quer parar de rastrear! Utilize o comando /untrack junto com o nome de usuário do Last.fm como no exemplo a seguir: <code>/untrack MelodyScout</code>')
