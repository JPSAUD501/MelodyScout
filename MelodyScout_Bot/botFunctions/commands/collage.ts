...
export async function runCollageCommand (msPrismaDbApi: MsPrismaDbApi, ctx: CommandContext<Context>): Promise<void> {
  ...
  inlineKeyboard.text(lang(ctxLang, { key: 'collageOverallButton', value: '[📆] - Vida toda' }), getCallbackKey(['CLG', 'overall']))
  ...
  inlineKeyboard.text(lang(ctxLang, { key: 'collage3monthButton', value: '[📆] - Últimos 3m' }), getCallbackKey(['CLG', '3month']))
  inlineKeyboard.row()
