...
export class MaintenanceinformCommand {
  ...
  async run (ctx: CommandContext<Context>): Promise<void> {
    ...
    await this.ctxFunctions.reply(ctx, 'Se você tiver alguma sugestão ou crítica, por favor entre em contato através do comando <code>/contact</code>! Eu ficarei muito feliz em ouvir o que você tem a dizer!')
